        ...
        line_items: [
            {
                price_data: {
                    ...
                    product_data: {
                        ...
                        description: `Rent for ${rentalRequest.property.address}, ${rentalRequest.property.city}`,
                    },
...
// get payment by id
const getPaymentById = async (paymentId: string, tenantId: string, role: string) => {
